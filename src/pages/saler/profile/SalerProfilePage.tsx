...
export const SalerProfilePage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await apiClient.put('/saler', formData, {
                headers: {
                    Authorization: `Bearer ${token}`,
        ...
        <Container maxWidth="sm" sx={{ mt: 4 }}>
            ...
            >
                ...
                <Field
                    ...
                    fullWidth
                />
                <Field label="Имя" value={saler.name || ''} onChange={handleFieldChange('name')} fullWidth />
                <Field label="Телефон" value={saler.phone} onChange={handleFieldChange('phone')} fullWidth />
                <Field
                    label="Новый пароль"
                    value={newPassword}
